...
// Define the props so TypeScript knows to expect onLoginSuccess
type LoginPageProps = {
  onLoginSuccess: () => void
}
    ...
    <div className="min-h-screen w-full bg-[#0f1419] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-[#161b22]/80 backdrop-blur-xl border border-gray-800/50 rounded-2xl shadow-2xl p-6 md:p-8">
          {/* Now passing the prop to the actual form */}
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">
            Need help?{' '}
            <a href="#" className="text-[#2d5f5d] hover:text-[#3d7a77] font-medium transition-colors">
              Contact Support
            </a>
          </p>
        </div>
